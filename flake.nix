{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/0.11.132/tar/kiro-ide-0.11.132-stable-linux-x64.tar.gz";
          hash = "sha256-tEVc+OpJUNofsSsLAiODSKhw3W3pdlDw1NmU2xEziMk=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
