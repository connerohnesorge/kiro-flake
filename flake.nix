{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/0.11.130/tar/kiro-ide-0.11.130-stable-linux-x64.tar.gz";
          hash = "sha256-DFU2YdQiU59rtp0lHe6XSo55Mfx77ePEAJ1TLFr3qEE=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
