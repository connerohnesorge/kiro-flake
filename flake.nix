{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/0.9.40/tar/kiro-ide-0.9.40-stable-linux-x64.tar.gz";
          hash = "sha256-kk6ejehoy72h8SE/Z33Andz6rRY9XQMDdkGLLkBJDco=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
