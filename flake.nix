{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/1.0.165/tar/kiro-ide-1.0.165-stable-linux-x64.tar.gz";
          hash = "sha256-tMUMs9oA1LnmkgOTSmOupuGOO+8B7e7flXZ9o5fL1KY=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
