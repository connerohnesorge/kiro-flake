{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/0.10.16/tar/kiro-ide-0.10.16-stable-linux-x64.tar.gz";
          hash = "sha256-QIcl9aTQsmyn3NVTTjSQBS36VCwIBQw3Ss+RTe2OsW4=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
