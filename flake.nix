{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/0.12.155/tar/kiro-ide-0.12.155-stable-linux-x64.tar.gz";
          hash = "sha256-HJmElCIseeLdGHOFNtaDqypYNqAGfPArddYBMTaUzbY=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
