{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/1.0.212/tar/kiro-ide-1.0.212-stable-linux-x64.tar.gz";
          hash = "sha256-swYH0ucJbI6Z3ASUI4IXeDfqH5qF3ZzSvLHl8FGrsc8=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
