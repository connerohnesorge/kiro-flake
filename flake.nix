{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      releaseConfig = {
        "x86_64-linux" = {
          url = "https://prod.download.desktop.kiro.dev/releases/stable/linux-x64/signed/0.12.224/tar/kiro-ide-0.12.224-stable-linux-x64.tar.gz";
          hash = "sha256-FIWz4VHo3BUib6/s03eh/phJaJtl6y7Qiu8y0zSaryE=";
          platform = "linux";
          enabled = true;
        };
        "aarch64-darwin" = {
